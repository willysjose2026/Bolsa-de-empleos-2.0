...
const Post = (prop) => {
  const { postData, categories } = prop;
          ...
          <form className="form-group" onSubmit={postData}>
            ...
            <div class="m-4 form-group">
              ...
              <select className="d-inline form-select w-25" name="select">
                {categories.filter((x) => Object.keys(x).length !== 0).map((x) => (
            ...
            <div className="form-check">
              ...
              <input type="radio" name="radioValue" value={2} />
              <label className="d-inline form-label m-3">Part time</label>
              <input type="radio" name="radioValue" value={3} />
            ...
            <div className="m-4 form-group d-flex">
              <label className="col-sm-2 col-form-label">How to Applay</label>
              <textarea
